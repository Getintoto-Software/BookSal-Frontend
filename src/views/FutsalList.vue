                ...
                <aside class="filters-sidebar" :class="{ 'active': showFilters }">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="price-range">
                            <input type="range" v-model="priceRange" min="500" max="3000" step="100"
                                class="price-slider">
                            ...
                            <div class="futsal-content">
                                ...
                                <div class="futsal-actions">
                                    ...
                                    <div class="action-buttons">
                                        <router-link :to="`/futsals/${futsal.id}`" class="view-details-btn">View
                                            Details</router-link>
...
const filteredFutsals = computed(() => {
    ...
    result = result.filter(futsal =>
        parseFloat(futsal.price_per_hour) <= priceRange.value
    );
...
const sortFutsals = (futsalList) => {
    switch (sortBy.value) {
        case 'price_asc':
            return [...futsalList].sort((a, b) => parseFloat(a.price_per_hour) - parseFloat(b.price_per_hour));
        case 'price_desc':
            return [...futsalList].sort((a, b) => parseFloat(b.price_per_hour) - parseFloat(a.price_per_hour));
        case 'name_asc':
