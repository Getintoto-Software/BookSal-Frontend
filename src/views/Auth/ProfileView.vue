          ...
          <div class="profile-header-content">
            ...
            <div class="profile-info">
              ...
              <div class="profile-actions">
                ...
                <button
                  v-if="userProfile.is_futsal_admin"
            ...
            <div class="futsals-grid">
              <div v-for="futsal in futsals" :key="futsal.id" class="futsal-card">
                <div class="futsal-image-container">
                  <img
                    :src="futsal.futsal_image_1 || 'https://via.placeholder.com/300x200'"
                    :alt="futsal.name"
                    class="futsal-image"
                  />
                ...
                <div class="futsal-content">
                  ...
                  <div class="futsal-actions">
                    ...
                    <router-link
                      :to="`/futsal/${futsal.id}/add-regular-booking`"
